...
ActiveRecord::Schema.define(version: 2023_01_04_224030) do
  ...
  create_table "bookmarks", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["user_id", "exhibition_id"], name: "index_bookmarks_on_user_id_and_exhibition_id", unique: true
  ...
  add_foreign_key "bookmarks", "exhibitions"
  add_foreign_key "bookmarks", "users"
  add_foreign_key "exhibitions", "users"
  add_foreign_key "works", "exhibitions"
